...
/**
 * Servlet for user-oriented webapp response time chart request,
 ...
 *
 */
public class GetUserResponseTimeInfo extends HttpServlet {
	
	private static final long serialVersionUID = -611386441821685304L;
