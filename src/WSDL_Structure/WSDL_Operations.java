...
public class WSDL_Operations{
	...
	/*.......????super()用在此处起的作用......*/
	//重构函数
	public WSDL_Operations() {
		super();
	}
    public WSDL_Operations(String style) {
		super();
		setStyle(style);
		
	}
	
    public WSDL_Operations(String name,String other) {
	...
	//获取、添加操作对应的输入参数
	/*public void addInparameter(WSDL_ParameterInfo parameter) {
		this.inparameters.add(parameter);
	}*/
	public void addInparameter(List inlist) {
		this.inparameters = inlist;
	}
	...
	//获取、添加操作对应的输出参数
	/*public void addOutparameter(WSDL_ParameterInfo parameter) {
		this.outparameters.add(parameter);
	}*/
	public void addOutparameter(List outlist) {
		this.outparameters = outlist;
	}
	...
	public void setInChildren(List children) {
		this.inparameters = children;
	}
	public void setOutChildren(List children) {
		this.outparameters = children;
	}
