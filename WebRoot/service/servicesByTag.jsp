					...
					<table width="100%"><tr>
						...
						<td align="right">
							<s:if test="page.pageIndex>1">
								<a href="service/ServicesByTag.action?tagName=<s:property value="tagName" />&page_mode=first&page_index=<s:property value="page.pageIndex"/>">first</a>&nbsp;|&nbsp;
								<a href="service/ServicesByTag.action?tagName=<s:property value="tagName" />&page_mode=priv&page_index=<s:property value="page.pageIndex"/>">previous</a>
							</s:if>
							<s:if test="page.pageIndex>1 && page.pageCount>page.pageIndex">&nbsp;|&nbsp;</s:if>
							<s:if test="page.pageCount>page.pageIndex">
								<a href="service/ServicesByTag.action?tagName=<s:property value="tagName" />&page_mode=next&page_index=<s:property value="page.pageIndex"/>">next</a>&nbsp;|&nbsp;
								<a href="service/ServicesByTag.action?tagName=<s:property value="tagName" />&page_mode=last&page_index=<s:property value="page.pageIndex"/>">last</a>&nbsp;
							</s:if>
						</td>
					</tr></table>
				</div>
