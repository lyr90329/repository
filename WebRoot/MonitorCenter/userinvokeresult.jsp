			 			...
			 			<%for(Iterator<AppInfo> appIt=userInfo.getApps().iterator();appIt.hasNext();){
			 			 ...
			 			 <li>
			 				...
			 				<ul class="<%=appId.equals(reqappId)?"":"hide" %>">
								...
								<li>
									<a href="userinvokeresult.jsp?appId=<%=appId %>" class="<%=appId.equals(reqappId)?"current":"" %>">Invoke Result</a>
								</li>
			 				</ul>
			 			 </li>
			 			 <%} %>
			 ...
			 <div class="content_data">
				...
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img  id="show" src="GetUserInvokeResultInfo?appId=<%=reqappId %>&time=1" />
							</td>
						</tr>
					</table>
				</div>
