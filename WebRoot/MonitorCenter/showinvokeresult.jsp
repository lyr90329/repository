							...
							<ul class="<%=reqtomcatId!=null&&Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId?"":"hide" %>">
								...
								<li>
									...
									<ul class="<%=reqappId!=null&&Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId&&reqappId.equals(appId)?"":"hide" %>">
										...
										<li>
											<a href="showinvokeresult.jsp?hostId=<%=hostId %>&&tomcatId=<%=tomcatId %>&&appId=<%=appId %>" class="<%=Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId&&appId.equals(reqappId)?"current":"" %>">Invoke Result</a>
										</li>
									</ul>
								</li>
								<%} %>
			...
			<div class="content_data">
				...
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img  id="show" src="GetInvokeResultInfo?hostId=<%=reqhostId %>&tomcatId=<%=reqtomcatId %>&appId=<%=reqappId %>&time=1" />
							</td>
						</tr>
					</table>
				</div>
