<%@ page language="java" import="java.util.*,monitor.bean.*,monitor.util.*" pageEncoding="ISO-8859-1"%>
<%
		...
		<div id="content">
			 ...
			 <ul>
			 	<li>
			 		...
			 		<ul>
			 			<li>
			 				<a href="usercpu.jsp" class="<%=reqappId==null?"current":"" %>">Cpu</a>
			 			</li>
			 			<%for(Iterator<AppInfo> appIt=userInfo.getApps().iterator();appIt.hasNext();){
			 			 ...
			 			 <li>
			 				...
			 				<ul class="<%=appId.equals(reqappId)?"":"hide" %>">
			 					<li>
									<a href="usercpu.jsp?appId=<%=appId %>" class="<%=appId.equals(reqappId)?"current":"" %>">Cpu</a>
								</li>
								<li>
									<a href="userthroughput.jsp?appId=<%=appId %>">Throughput</a>
								</li>
								<li>
			 ...
			 <div class="content_data">
				<div class="content_data_title">
					<%=reqappId==null?"Total":reqappId %> CPU
				</div>
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img id="showcpu" src="GetUserCpuInfo?<%=reqappId==null?"time=1":"appId="+reqappId+"&time=1" %>"/>
							</td>
						</tr>
					</table>
				</div>
