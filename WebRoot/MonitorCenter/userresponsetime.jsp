			 			...
			 			<%for(Iterator<AppInfo> appIt=userInfo.getApps().iterator();appIt.hasNext();){
			 			 ...
			 			 <li>
			 				...
			 				<ul class="<%=appId.equals(reqappId)?"":"hide" %>">
								...
								<li>
									<a href="userresponsetime.jsp?appId=<%=appId %>" class="<%=appId.equals(reqappId)?"current":"" %>">Response Time</a>
								</li>
								<li>
			 ...
			 <div class="content_data">
				...
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img id="show" src="GetUserResponseTimeInfo?appId=<%=reqappId %>&time=1" />
							</td>
						</tr>
					</table>
				</div>
