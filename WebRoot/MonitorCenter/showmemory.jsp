			 		...
			 		<ul>
			 			...
			 			<li>
							...
							<ul class="<%=reqhostId==null&&hostId!=host.getFirstHostInfo().getId()||reqhostId!=null&&Integer.parseInt(reqhostId)!=hostId?"hide":"" %>">
								...
								<li>
									<a href="showmemory.jsp?hostId=<%=hostId %>" class="<%=reqhostId==null&&hostId==host.getFirstHostInfo().getId()||reqhostId!=null&&reqtomcatId==null&&hostId==Integer.parseInt(reqhostId)?"current":"" %>">Memory</a>
								</li>
								<li>
						...
						<li>
							...
							<ul class="<%=reqtomcatId!=null&&Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId?"":"hide" %>">
								...
								<li>
									<a href="showmemory.jsp?hostId=<%=hostId %>&&tomcatId=<%=tomcatId %>" class="<%=reqtomcatId!=null&&Integer.valueOf(reqhostId)==hostId&&tomcatId==Integer.valueOf(reqtomcatId)?"current":"" %>">Momory</a>
								</li>
			...
			<div class="content_data">
			 ...
			 %>
				<div class="content_data_title">
					Host <%=reqhostId==null?"0":reqhostId %> Memory
					<em>refresh per 
					<select>
						<option>5</option>
						<option>10</option>
				...
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img id="show" src="GetMemoryInfo?hostId=<%=reqhostId %>&time=1"/>
							</td>
						</tr>
						<tr>
						</tr>
			 ...
			 %>
				...
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img id="show" src="GetMemoryInfo?hostId=<%=reqhostId %>&tomcatId=<%=reqtomcatId %>&time=1"/>
							</td>
						</tr>
						<tr>
						</tr>
