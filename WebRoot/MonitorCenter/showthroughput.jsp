							...
							<ul class="<%=reqtomcatId!=null&&Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId?"":"hide" %>">
								...
								<li>
									...
									<ul class="<%=reqappId!=null&&Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId&&reqappId.equals(appId)?"":"hide" %>">
										...
										<li>
											<a href="showthroughput.jsp?hostId=<%=hostId %>&&tomcatId=<%=tomcatId %>&&appId=<%=appId %>" class="<%=Integer.valueOf(reqhostId)==hostId&&Integer.valueOf(reqtomcatId)==tomcatId&&appId.equals(reqappId)?"current":"" %>">Throughput</a>
										</li>
										<li>
			...
			<div class="content_data">
				...
				<div class="content_data_table">
					<table>
						<tr>
							<td>
								<img id="show" src="GetThroughputInfo?hostId=<%=reqhostId %>&tomcatId=<%=reqtomcatId %>&appId=<%=reqappId %>&time=1" />
							</td>
						</tr>
					</table>
				</div>
