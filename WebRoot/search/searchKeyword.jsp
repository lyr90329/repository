					  	...
					  	<div class="lines">
					  		<table width="100%" border="0"><tr>
						  		<td align="left" width="500">
									...
									<div>Provider <a href="<s:property value="url"/>"><s:property value="url"/></a></div>
									<div>Description: <s:property value="description"/></div>
								</td>
								<td align="right">
									<s:if test="#session.userName!=null">
										<div style="margin-right:10px;"><a href="credit/survey.jsp?serviceID=<s:property value="id"/>&jobID=<s:property value="jobId" />&isLogin=1">Rank</a></div>
									</s:if>
									<s:else>
										<div style="margin-right:10px;"><a href="credit/survey.jsp?serviceID=<s:property value="id"/>&jobID=<s:property value="jobId" />&isLogin=0">Rank</a></div>
									</s:else>
									<s:if test="#session.userName==userName">
										<div style="margin-left:5px;margin-right:10px;"><a href="service/ServicePreUpdate.action?serviceId=<s:property value="id" />">Update</a></div>
									</s:if>
									<s:else>
										<div class="deadLink" style="margin-left:5px;margin-right:10px;">Update</div>
									</s:else>
								</td>
							</tr></table>
					  	</div>
