...
<div id="content">
    <div id="postarea">
    	<div id="top_search">
    		<form action="appengine?action=deploy" method=post enctype="multipart/form-data" >
    		<table width="560" height="50">
    			<tr >
    				<td><input type=file size="30" value="upload your own Web App" name="app_file" onfocus="if (this.value == 'upload your own Web App') {this.value = '';}" onblur="if (this.value == '') {this.value = 'upload your own Web App';}"></td>
 	...
 	<%
     	Client client = new Client(remoteUri);
     	List<AppInfo> apps = client.appQuery(name);
     	List<String> ids  = new ArrayList<String>();
     	for(AppInfo info : apps){
     		if(ids.contains(info.getAppID())){
     			continue ;
     		}
   		...
   		<div class="excrept_post">
    		...
    		<!-- Thumbnail from Custom Field, Post first image or default thumbnail -->
				...
				<div class="the_excrept"><font size="3" face="Verdana">Service Name:</font>
            		<font size="2" ><a href="#" name="appName"><%=info.getAppName() %></a></font>
            	</div>
            	<div class="the_excrept"><font size="3" face="Verdana">Service ID:</font>
            		<font size="2" ><a href="#" name="appID"><%=info.getAppID() %></a></font>
            	</div>
            	<div class="the_excrept"><font size="3" face="Verdana">InvokeUrl:</font>
            		<font size="2" ><a href="<%=info.getUrl()%>" target="_blank"><%=info.getUrl() %></a></font>
            	</div>
        		<div class="clear"></div> 
        		...
        		<div class="excrept_data">
            		...
            		<div class="options">
            		<form action="appengine?action=undeploy" method="post">
				    	<input type="hidden" name="appID" value="<%=info.getAppID()%>" ></input>
                		<input style="width:80px;font-family:verdana" type="submit" value="Remove" id="remove"></input>
                	</form>
                	</div>
            		</div>
        			<div class="clear"></div>
