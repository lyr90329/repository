...
import="repository.atomicServices.ManageServiceClient,java.util.*,db.dao.*,db.entity.*,constant.MenuItems,constant.MenuItems,loginfo.*,javax.xml.parsers.*,org.w3c.dom.*,java.io.*,org.xml.sax.InputSource"%>
<%
...
<%
	...
	NodeList plist=null;
	try {
			String logContent=client.testLogFile(serviceid, name);
			System.out.println("logContent£º"+logContent);
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
			DocumentBuilder builder = factory.newDocumentBuilder();
			StringReader sr = new StringReader(logContent);
			InputSource is = new InputSource(sr);
			
			Document doc=builder.parse(is);
			
			plist=doc.getElementsByTagName("content");
			System.out.println("plist£º"+plist.getLength());
		} catch (Exception e) {
	...
	<!-- sandbox info -->
		<div class="excrept_post">
			<div class="excrept_in">
    			<div class="the_excrept"><font size="5" face="Verdana" color="black">Log Info:</font>
            		<font size="3" color="black">log info from your Web Service</font>
            	</div>
            	<div class="the_excrept">
            		...
            		<font size="3" face="Verdana" color="red">[Log&nbsp;<%=i%>]:&nbsp;</font><font size="3" face="Verdana" color="green"><%=plist.item(i).getTextContent()%><br/></font><br/>
            		<%} %>
            	</div>
        		<div class="clear"></div> 
    		</div>
