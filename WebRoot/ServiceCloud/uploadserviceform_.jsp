...
<html>
 ...
 <script type="text/javascript">
	...
	function invoke(userName,serviceName,deployid,soaptype,operation)
	{
		...
		go.disabled=true;
	    AjaxSubmit("userName="+userName+"&serviceName="+serviceName+"&deployid="+deployid+"&soaptype="+soaptype+"&operation="+operation+"&soapContent=" + <%=soapContent %> + "&paramList="+b,"/repository/ServiceCloud/invokeupservice.jsp");
	}
