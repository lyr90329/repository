		...
		<div class="excrept_post">
    		...
    		<!-- Thumbnail from Custom Field, Post first image or default thumbnail -->
        		<div class="excrept_data">
					...
					<form action="DownloadCassandraServiceClient" method="post" >
            		<table>
            			<tr>
            			<td><label for="dataUserName">User Name for DataService: </label></td>
				    	<td><input type="text" value="<%= userName%>" name="dataUserName" ></input></td>
				    	</tr>
				    	
            			<tr>
            			<td><label class="control-label" for="dataUserName">Password for DataService: </label></td>
				    	<td><input type="password" name="dataUserPasswd" ></input></td>
				    	</tr>
            			
				    	<tr>
            			<td><label class="control-label" for="dataUserName">Confirm Password: </label></td>
				    	<td><input type="password" name="confirmDataUserPasswd" ></input></td>
				    	</tr>				    	
                		<tr><td></td><td style="text-align:right"><input type="submit" value="Apply" ></input></td></tr>
                	</table>
                	</form>
    ...
    <div id="sidebar"><!-- Sidebar Start Here -->
        ...
        <div class="widget"><h2>Cassandra DataService</h2>
			<ul class='xoxo blogroll'>
				...
				<li><p><b>It is convenient for you to manage large amounts of structured, semi-structured, and unstructured data across multiple data centers and the cloud.</b></p></li>
			</ul>
		</div>
