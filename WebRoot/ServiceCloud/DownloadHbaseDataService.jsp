...
<div id="content">
		...
		<div class="excrept_post">
    		...
    		<!-- Thumbnail from Custom Field, Post first image or default thumbnail -->
        		<div class="excrept_data">
					...
					<div class="the_excrept"><font size="3" face="Verdana">User Name:</font>
	            		<font size="2" ><a href="#" name="serviceName"><%= (String) request.getAttribute("userName") %></a></font>
	            	</div>
	            	<div class="the_excrept"><font size="3" face="Verdana">Data Service Password:</font>
	            		<font size="2" ><a href="#" name="serviceName"><%=(String) request.getAttribute("passwd") %></a></font>
	            	</div>
	            	<div class="the_excrept"><font size="3" face="Verdana">Config File:</font>
	            		<font size="2" ><a href="<%= (String) request.getAttribute("filePath") %>" target="_blank">Download</a></font>
	            	</div>
	            	<div class="the_excrept"><font size="3" face="Verdana">Data Service Client:</font>
	            		<font size="2" ><a href="<%= (String) request.getAttribute("clientPath") %>" target="_blank">Download</a></font>
	            	</div>
	        		<div class="clear"></div> 
					</div>
				</div>
    ...
    <div id="sidebar"><!-- Sidebar Start Here -->
        ...
        <div class="widget"><h2>Hbase DataService</h2>
			<ul class='xoxo blogroll'>
				<li><p><b>This cloud data service is based on Apache Hbase.</b></p></li>
				<li><p><b>It is perfect for managing large amounts of structured, semi-structured, and unstructured data across multiple data centers and the cloud.</b></p></li>
			</ul>
		</div>
		
		<div class="widget"><h2>Getting Started</h2>			
			<ul>
				<li><p><b>You need to apply for a data service account before use the dataservice. </b></p></li> 
				<li><p><b>You can download the client of our data service after you complete your application. </b></p></li> 
			</ul>
		</div>
		</div>
