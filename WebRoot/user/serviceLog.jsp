...
<div class="outer"><table><tr><td>
	...
	<div class="accountInfo">
		<div class="inner_title"><strong>Service Log</strong></div>
		<s:iterator value="serviceLogList">
			<div class="log">On <s:property value="timestamp" /> You Scanned the Service <a href="service/ServiceOverView.action?serviceId=<s:property value="serviceId" />"><s:property value="serviceName" /></a>.</div>
		</s:iterator>
	</div>
