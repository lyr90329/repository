...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="user/css/register.css" media="screen" />
		...
		<div class="login_container">
			<form action="user/SaveUser.action" method="post" onsubmit="return signUp(this)">
				...
				<div class="control_botton">
					<input type="image" src="user/img/register_button.gif"> or <a href="service/GetAllServiceInfo.action">cancel</a>
				</div>
			</form>
		</div>
	</div>
