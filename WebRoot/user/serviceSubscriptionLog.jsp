...
<html>
  <head>
    ...
    <title>Service Subscription Log</title>
...
<div class="outer"><table><tr><td>
	...
	<div class="accountInfo">
		<div class="inner_title"><strong>Service Subscription Log</strong></div>
		<s:iterator value="serviceSubscriptionList">
			<div class="log">You Subscript the Service <a href="service/ServiceOverView.action?serviceId=<s:property value="serviceId" />"><s:property value="serviceName" /></a>.</div>
		</s:iterator>
	</div>
